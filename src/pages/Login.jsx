  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-white p-6">
      <div className="w-full max-w-sm min-h-screen bg-gray-50 flex flex-col p-6 border-[2px] border-gray-200">
        <button onClick={() => navigate(-1)} className="mb-4 text-purple-600 ml-[-300px]">← Back</button>

        <h2 className="text-2xl font-bold mb-2 w-[200px]">Signin to your PopX account</h2>
        <p className="text-gray-600 mb-6 w-[250px]">Lorem ipsum dolor sit amet, consectetur adipiscing elit.</p>
